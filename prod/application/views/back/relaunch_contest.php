...
<?php require('include/side_bar.php'); ?>        
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Contests List
                        <small>List of Relaunch able contest</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">contest List</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
										...
										foreach($contest_details as $cd) { $i = $i+1; ?>
                                            <tr>
                                                ...
                                                <td> <a href="<?php echo base_url();?>admin_panel/contest_view/<?php echo $cd->id; ?>">View</a> </td>
