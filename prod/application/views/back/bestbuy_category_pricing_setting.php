...
<div class="page-container">
   ...
   <div class="page-content-wrapper">
      ...
      <div class="page-content">
         ...
         <!-- BEGIN PAGE TITLE-->
         <h3 class="page-title"> 
           Bestbuylogo Category Based Pricing
         </h3>
         <!-- END PAGE TITLE-->
         <!-- END PAGE HEADER-->
         <div class="row">
            <div class="col-md-12">
               <div class="portlet light portlet-fit portlet-form bordered">
                  ...
                  <div class="portlet-body">
                     <!-- BEGIN FORM-->
                     <form action="<?php echo base_url();?>admin_panel/save_bestbuy_category_pricing_setting" class="form-horizontal" id="form_sample_1" method="post">
                        <div class="form-body">
