...
<?php require('include/side_bar.php'); ?>        
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        ...
                                        $contest_category1 = get_category_type($cd->id);
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url();?>admin_panel/contest_delete/<?php echo $cd->id; ?>" class="btn btn-success red">Delete</a> 
                                                </td>
                                            </tr>
                                        <?php }?>
 ...
 $(document).ready(function(){
	...
	$(document).on("change", "#postedfrom", function(e) {
		window.location.href = "<?php echo base_url();?>admin_panel/open_contest/"+$(this).val();
	});
 });
 </script>   