...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    ...
    <div class="page-content">
      <h3 class="page-title"> Request Payment Details 
        <small>
        </small> 
      </h3>
      <!-- END PAGE TITLE-->
              ...
              <table class="table table-striped table-bordered table-hover" id="sample_1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn red btn-outline sbold s2" data-designer="<?php echo $req->designer_id ?>" data-req="<?php echo $req->id;?>" data-amt="<?php echo $req->request_amount;?>" data-toggle="modal" href="#basic">Release Payment
                      </a>
                         <a href="<?php echo base_url();?>admin_panel/view_payment_delete/<?php echo $req->id; ?>" class="btn btn-success red">Delete</a> 
                    </td>
                  </tr>
                  <?php }?> 
                </tbody>
...
<div class="modal fade" id="basic" tabindex="-1" role="basic" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?php echo base_url();?>Admin_panel/transaction_update" method="post">
            ...
            <div class="form-body">
              <div class="form-group form-md-line-input"> 
                ...
                <div class="col-md-8"> 
                  ...
                  <input type="hidden" name="designer_id" class="designer_id"> 
