...
<?php require('include/side_bar.php'); ?>        
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Completed Contests
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
										...
										foreach($contest_details as $cd) { $i = $i+1; ?>
                                            <tr>
                                                ...
                                                <td> <a href="<?php echo base_url();?>admin_panel/contest_view/<?php echo $cd->id;?>">View</a> 
                                                 <a href="<?php echo base_url();?>admin_panel/complete_delete/<?php echo $cd->id;?> ">Delete</a></td>
 ...
 $(document).ready(function(){
	$(document).on("change", "#postedfrom", function(e) {
		window.location.href = "<?php echo base_url();?>admin_panel/completed_contest/"+$(this).val();
	});
 });
 </script>    