               ...
               <div class="portlet-body form">
                  ...
                  <form class="form-horizontal" role="form" method="post">
                     <div class="form-body">
                        ...
                        <h3 class="form-section">Judging Contest</h3>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <p class="form-control-static">
                                       <?php if($cd->contest_type != 'logodesign' && $cd->contest_type != 'webdesign' && $cd->contest_type != 'movielogodesign' ){ echo $cd->contest_title;} else { echo $cd->org_name; } ?>
                                 </div>
                              </div>
                           </div>
                           <!--/span-->
