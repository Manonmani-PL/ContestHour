                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form class="form-horizontal" role="form" method="post" action="<?php echo base_url();?>admin_panel/contest_status/<?php echo $cont_det[0]->id;?>">
                                                    <div class="form-body">
                                                        <h2 class="margin-bottom-20"> View Contest Info </h2>
                                                        <h3 class="form-section">New Contest</h3>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="row">
                                                                    <div class="col-md-offset-3 col-md-9">
                                                                        <button type="submit" class="btn green" id="approve" value="1">
                                                                            <i class="fa fa-pencil"></i> Click here to Approve</button>
