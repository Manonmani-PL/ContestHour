...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Contest Hours | Admin Login</title>
        ...
        <link href="<?php echo base_url(); ?>admin_assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="<?php echo base_url();?>admin_panel">
                <img src="<?php echo base_url(); ?>admin_assets/layouts/layout/img/logo-01.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url(); ?>admin_panel" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" value="<?php if(isset($_POST['username'])){ echo $_POST['username']; } ?>" />
                <?php if(form_error("username")){?><span style="color:#d16e6c;"><?php echo form_error("username"); ?></span><?php }?>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" value="<?php if(isset($_POST['password'])){ echo $_POST['password']; } ?>" /> 
                <?php if(form_error("password")) {?><span style="color:#d16e6c;"><?php echo form_error("password"); ?></span><?php } ?>
                </div>
                <div>
                	<?php if($this->session->flashdata('login_fail')) echo $this->session->flashdata('login_fail'); ?>
                </div>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>admin_assets/pages/scripts/login.min.js" type="text/javascript"></script>
