...
<?php require('include/side_bar.php'); ?>        
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Payment Package Price Setting
                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                         <?php if($this->session->flashdata('message')){ echo $this->session->flashdata('message');} ?>
							<div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="<?php echo base_url();?>admin_panel/add_package_cost" class="form-horizontal" id="form_sample_1" method="post">
                                        <div class="form-body">
											<!--
											...
											<br>
                                              <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1"><b>Referral Amount (%)</b></label>
                                            </div>  
                                                    <div class="form-group form-md-line-input">
                                               ...
                                               <div class="col-md-5">
                                                    <input type="text" class="form-control" required placeholder="" id="referral_amount" name="referral_amount" value="<?php if(isset($setval->referral_amount) && !empty($setval->referral_amount)){ echo $setval->referral_amount; }else{ echo 0; } ?>"  onkeypress="return isNumberKey(event)"/>
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">Referral Amount Define Her</span>
                                                </div>
                                            </div> 

                                              <!--   <div class="form-group form-md-line-input">
                                                    <label class="col-md-3 control-label" for="form_control_1">User Referral
                                                        <span class="required">*</span>
                                                    </label>
                                                   <div class="col-md-5">
                                                        <input type="text" class="form-control" required placeholder="" id="referral_allow_user" name="referral_allow_user" value="<?php //if(isset($setval->referral_allow_user) && !empty($setval->referral_allow_user)){ echo $setval->referral_allow_user; }else{ echo 0; } ?>"  onkeypress="return isNumberKey(event)"/>
                                                        <div class="form-control-focus"> </div>
                                                        <span class="help-block">Referral Code Use The Admin Define Her</span>
                                                    </div>
                                                </div> -->
