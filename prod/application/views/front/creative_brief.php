         ...
         <div class="row">
            ...
            <div class="col-md-3 col-lg-3">
               <div class="creative_brief">
                  <div class="creative_brief_icon"><img class="noimgshawdow" src="<?php echo base_url();?>assets/image/creative_brief_active_icon.png" width="71" height="72" />&nbsp;&nbsp;<span class="select">Creative brief</span></div>
               </div>
            </div>
            <div class="col-md-3 col-lg-3">
               ...
               <div class="col-md-6 col-lg-6">
                  <div class="creative_brief">
                     ...
                     <tr>
                        <td>
                           ...
                           <?php  
                              ...
                              else if($design_type == 'movielogodesign'){
                              echo "Movie Name";
                              }
                              else{
                     ...
                     <tr>
                        <td><label>
                           <?php  
                              if($design_type == 'movielogodesign'){
                              echo "Please describe movie genre";
                              }
                              else{
                              echo "Please describe what your business does in few sentences";
                              }
                              ?>
                           </label>
                        </td>
					...
					<table width="100%" cellpadding="5" cellspacing="5" class="attachment">
					   ...
					   <tr>
						  <td><input type="password" class="form-control" name="client_password"></td>
					   </tr>
					</table>
					<?php } ?>
                  </div>
