    ...
    <tbody>
        ...
        <tr>
            <td style="padding:10px 10px 30px 10px;border:none;font-size:16px;color:#424242;text-align:justify;line-height:150%;font-family:&quot;Helvetica Neue&quot;,&quot;Helvetica&quot;,Helvetica,Arial,sans-serif"><p>
                                   We have received your withdraw request on <b> <?php echo date("d/M/Y",strtotime($request_date));?></b> You should receive your payment within 5 to 7 working days of you making the request. If you have not received your payment after 7 working days, please let us know by replying back to this message.
                                    <br>
                                    <br>
								Important: If you didn’t make the withdraw request, please also let us know ASAP!
									<br>
