      ...
      <tbody>
         ...
         <tr>
            <td style="padding:10px 10px 30px 10px;border:none;font-size:16px;color:#424242;text-align:justify;line-height:150%;font-family:&quot;Helvetica Neue&quot;,&quot;Helvetica&quot;,Helvetica,Arial,sans-serif">
               <p>
                  <b> Design Package</b> for <b>"<a href="<?php echo base_url()."contest/contest_designpackage/".$contest_id;?>"><?php echo ucwords(contestname($contest_id));?></a>"</b> was uploaded by the designer. Please confirm the package if everything is correct. Or message if you have any questions with regard to the package file.
                  <br>
                  <br>
                  Best Regards,
                  <br>
