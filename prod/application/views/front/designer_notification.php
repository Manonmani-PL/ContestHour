  ...
  <div class="col-sm-9">
    	<div class="row">
            <div class="col-sm-12">
                ...
                <div class="jointable">
                <h3 class="dashboard_title">Designer Notifications</h3>
			  ...
			  ?>
				<tr class="<?php echo ($tmp->read_status == 0)?"unread":""; ?>">
					...
					<?php } else{ ?>
					<td> Contesthours </td>
                    <td><a class='changeread' href="<?= base_url();?>admin/notifications" for='Notifications'><?php  echo $tmp->subject; ?></a></td>
                    <td><?php echo date("d/m/Y", strtotime($tmp->created_time)) ?></td>  
					<td><a href="<?= base_url();?>admin/notifications">View</a></td>
					<?php } ?>
                </tr>				
				<?php
					}			
