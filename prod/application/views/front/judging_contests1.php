  ...
  <main id="main">
	...
	<section id="contest-list-header">
		<div class="container">
			<div class="row">
				<div class="col-lg-4">
					<h3 class="list-header-title">Judging Contest <span><?php echo $count_contests; ?></span></h3>
				</div>
	...
	?>		
          ...
          <div class="item-block wow fadeInUp">
            ...
            <div class="row" style="border:1px solid rgba(0,0,0,0.1);border-right:0px solid red;border-left:0px solid red;">
                <div class="col-md-12 col-lg-12">
                    <p class="text-center" style="height:407px; line-height:60px;">No Contest Found....</p>
                </div>
            </div>
       ...
       <div class="row"> 
			<div class="col-md-4 offset-8 text-right">
				<ul class="pagination">
				<?php echo pagination("admin/judgingContests",$count_contests,20);?>
				  <!-- <li class="page-item"><a class="page-link" href="#"><?php// echo pagination("admin/contestCompleted",$count_contests,20);?></a></li> -->
...
$( ".drop_ajax" ).change(function(e) {
		...
		$.ajax
			({
				...
				url:'<?php echo base_url();?>contest/choose_judgingContests/',
