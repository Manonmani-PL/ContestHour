   ...
   <form action="#" method="post" enctype="multipart/form-data">
      <div class="row right-border" style="border:0px solid red;">
         <div class="col-sm-12 col-xs-12">
			...
			<div class="row">
				<div class="jointable">
				 <h3 class="">Client Referral Code</h3>
				</div>
					<div class="col-md-4 col-lg-4">
						<span style="background:#c3bcbc; padding:10px; margin-top:10px; display:table; width:100%; font-size: 18px; color: #fff; text-align: center;"><?php if($referral_code !=""){
						echo $referral_code; } else { echo "No Referral Code" ;} ?></span>
					</div>
				<!-- <div class="col-md-4 col-lg-4">
