  ...
  <main id="main">
	...
	<section id="contest-list-header">
		<div class="container">
			<div class="row">
				<div class="col-lg-4">
					<h3 class="list-header-title">Open Contest <span><?php echo isset($count_contests)? $count_contests:0; ?></span></h3>
				</div>
						...
						<span>
							...
							if($con_list->close_date < date("Y-m-d H:i:s")){
								echo "Finished Date";
							 	...
							 	$remain = remaining_time(date("Y-m-d H:i:s"),$con_list->close_date);
								echo $remain." -Time Remaining";
						}
							?></span>	
					</div>
					<div class="col-md-3 col-6 list-icons">
          ...
          <div class="item-block wow fadeInUp">
            ...
            <div class="row" style="border:1px solid rgba(0,0,0,0.1);border-right:0px solid red;border-left:0px solid red;">
                <div class="col-md-12 col-lg-12">
                    <p class="text-center" style="height:407px; line-height:60px;">Sorry!!! No Contest to display...</p>
                </div>
            </div>
