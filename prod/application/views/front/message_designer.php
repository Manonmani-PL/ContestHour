...
<div class="col-sm-9">
      <div class="row">
         <div class="col-sm-12">
            <div class="datatable">
               <h3 class="dashboard_title">Messages</h3>
               <table class="table table-hover" id="bootstrap-table">
                  ...
                  <tbody>
                     ...
                     <tr class="<?php echo ($tmp->read == 0)?"unread":""; ?>">
                        <td><?php echo ($tmp->createdby==0)?"Admin":username($tmp->createdby); ?></td>
                        <td><a class="changeread" for='<?php echo $tmp->dcmd_id; ?>' data-modal-id="popup<?php echo $tmp->dcmd_id;?>" ><?php echo contestname($tmp->contest_id); ?> - "<?php  echo $tmp->comment; ?> "</a></td>
                     ...
                     <div id="popup<?php echo $tmp->dcmd_id; ?>" class="modal-box">
                        ...
                        <div class="modal-body" style="padding:0px; ">
							<h4><a  style="color:#fbb03b;" href="<?php echo base_url()."contest/contest_entries/".$tmp->contest_id?>"><?php echo contestname($tmp->contest_id);?></a></h4> <span>#<?php echo contest_design_no($tmp->design_id)?></span>
                           ...
                           <form action="<?php echo base_url();?>contest/contest_privcomment" name="design_upload" method="post" enctype="multipart/form-data">
                              ...
                              <input type="hidden" name="shiftpress" value="2" />
                              <input type="hidden" name="designerid" value="<?php echo design_clientid($tmp->design_id); ?>" />
                              </br>
                              <input type="submit" class="precomm" value="Add Comment" />
                           </form>
                        </div>
                        <footer> 
							<a class="btn btn-small submit_cmt" style="background-color:#713365">Add Comment</a> 
							<a href="#" class="btn btn-small js-modal-close" style="background-color:#713365">Close</a> 
						</footer>
                     </div>
                     <?php 			}			
                        } ?>
