...
<div class="row" style="background-color:rgba(244,242,237,0.4); border:1px solid rgba(0,0,0,0.1);">
    	<div class="col-md-12 col-lg-12">
        	<div class="contest-completed">
            	<p>Judging Contests (<?php echo isset($count_contests)?$count_contests:0; ?>)</p>
            </div>
        </div>
    </div>
	...
	<div class="row" style="border:1px solid rgba(0,0,0,0.1);">
    	<div class="col-md-12 col-lg-12">
			<p class="text-center" style="height: 407px;line-height: 100px;color: #ff1414;">Sorry!!! No Contest to display...</p>
        </div>
    </div>
