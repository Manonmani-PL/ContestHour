        ...
        <div class="row">
            <div class="col-md-4 col-lg-4">
                <div class="contest-head">
                    <h4>Completed Contests (<?php echo $count_contests; ?>)</h4>
                </div>
            </div>
            ...
            <div class="row" style="border:1px solid rgba(0,0,0,0.1);border-right:0px solid red;border-left:0px solid red;">
                <div class="col-md-6 col-lg-6">
					...
					?>
                            ...
                            <p>
                                <?php echo $con_list->business_description; ?>
                            </p>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="Judging-Contests-prize">
                        ...
                        <?php } else { ?>
                        <p>Time Remaining:
                            <?php echo remaining_time(date("Y-m-d H:i:s"),$con_list->close_date);?>
                        </p>
                        <?php } ?>

                        <p style="color:#333">Posted:
                            <?php echo date("h:i A, d M, Y.",strtotime($con_list->published_date)); ?>
                        </p>
                    </div>
                </div>
            </div>
